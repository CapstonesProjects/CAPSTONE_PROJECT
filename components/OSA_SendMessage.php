    ...
    <div class="w-64 px-4">
        ...
        <div id="composeWindow" class="fixed bottom-0 right-0 bg-white shadow-lg rounded-lg p-4 w-1/4 h-auto hidden">
            ...
            <form>
                ...
                <div class="mb-2">
                    <input type="text" name="cc" id="cc" class="w-full text-gray-700 py-1 border-b border-b-gray-300 focus:outline-none focus:ring-0 focus:border-transparent focus:border-b-gray-300" placeholder="Subject">
                </div>
                <!-- <div class="mb-2">
                ...
                <div class="mt-7">
                    <textarea id="body" class="w-full h-64 max-h-1/2 text-gray-700 focus:outline-none focus:ring-0 focus:border-transparent focus:border-b-gray-300" placeholder="Message..."></textarea>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        <button class="bg-blue-500 hover:bg-blue-700 rounded-lg px-4 py-2 text-gray-100 hover:shadow-xl transition duration-150">Send</button>
