    ...
    <style>
        ...
        @media (min-width: 768px) {
            ...
            #sidebar.closed {
                ...
                /* Move it out of view when closed */
            }

            /* Header Styles */
            #hamburger {
                position: absolute;
                /* Fixed position within the header */
                top: 30px;
                /* Spacing from the top */
                left: 10px;
                /* Spacing from the left */
                z-index: 40;
                /* Ensure it sits above the header and sidebar */
                cursor: pointer;
                font-size: 1.5rem;
    ...
    <div id="view" class="h-full flex flex-row overflow-x-hidden">
        ...
        <div id="sidebar" class="bg-gray-300 h-screen md:block shadow-xl px-12 w-30 md:w-60 lg:w-80 overflow-x-hidden transition-transform duration-300 ease-in-out">
            <div class="absolute top-0 right-0 mt-2 ml-4">
                <a class="text-lg font-medium text-gray-700 py-3 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out" data-bs-toggle="modal" data-bs-target="#ChangePasswordModal<?php echo $_SESSION['AdminID']; ?>">
            ...
            <div class="space-y-6 md:space-y-10 mt-10">
                ...
                <div id="menu" class="flex flex-col space-y-3" style="margin-top: -10%;">
                    <a href="../Admin/Admin_Dashboard.php" class="text-lg font-medium <?php echo $activeMenu == 'dashboard' ? 'active' : 'text-black-700'; ?> py-2 px-2 hover:bg-teal-500 hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out">
                    ...
                    <a href="../Admin/Admin_Profile.php" class="text-lg font-medium <?php echo $activeMenu == 'admin_profile' ? 'active' : 'text-gray-700'; ?> py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">
                        <svg xmlns="http://www.w3.org/2000/svg" width="0.5em" height="0.5em" viewBox="0 0 24 24">
                    ...
                    <a href="../Admin/Admin_Send_Message.php" class="text-lg font-medium <?php echo $activeMenu == 'send_message' ? 'active' : 'text-gray-700'; ?> py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">
                        <svg xmlns="http://www.w3.org/2000/svg" width="0.5em" height="0.5em" viewBox="0 0 24 24">
                    ...
                    <a href="../ORGANIZATION/ORG_Events.php" class="text-lg font-medium <?php echo $activeMenu == 'events' ? 'active' : 'text-gray-700'; ?> py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">
                    ...
                    <a href="../Admin/Admin_ActivityLog.php" class="text-lg font-medium <?php echo $activeMenu == 'activity_log' ? 'active' : 'text-gray-700'; ?> py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
