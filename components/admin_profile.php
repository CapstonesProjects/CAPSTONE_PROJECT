...
$admin_number = $_SESSION['AdminID'];
$sql = "SELECT profile_picture FROM admin WHERE AdminID = ?";
...
<body>
    ...
    <div class="overflow-auto max-h-96">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div>
                <label class="block text-gray-700 text-sm font-bold mb-2">Admin ID:</label>
                <input type="text" value="<?php echo $_SESSION['AdminNumber'] ?>" class="w-2/3 px-3 py-2 border border-gray-300 rounded-md bg-gray-100 cursor-not-allowed" readonly>
            </div>
            <div>
