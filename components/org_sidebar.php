<?php if (isset($_SESSION['OrgID'])) {
    ...
    $query = "SELECT FirstName, LastName, Role, Email FROM tblusers_organization WHERE OrgID = ?";
...
include("../modals/ORG_SettingsModal.php");
?>
...
<body class="font-poppins antialiased">
    <div id="view" class="h-full flex flex-row overflow-x-hidden">
        ...
        <div class="absolute top-0 right-0 mt-2 ml-4">
                <a class="text-lg font-medium text-gray-700 py-3 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out" data-bs-toggle="modal" data-bs-target="#ChangePasswordModal<?php echo $_SESSION['OrgID']; ?>">
