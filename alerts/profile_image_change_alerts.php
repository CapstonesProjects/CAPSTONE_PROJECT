<?php
if (isset($_SESSION['success_image_change'])) {
  echo "
  ...
  unset($_SESSION['success_image_change']);
}

if (isset($_SESSION['error_image_change'])) {
  echo "
  ...
  // unset the session variable so it doesn't keep showing up
  unset($_SESSION['error_image_change']);
}
?>