<?php
if (isset($_SESSION['addingosa_success'])) {
  echo "
  ...
  unset($_SESSION['addingosa_success']);
}

if (isset($_SESSION['addingosa_error'])) {
  echo "
  ...
  // unset the session variable so it doesn't keep showing up
  unset($_SESSION['addingosa_error']);
}
?>