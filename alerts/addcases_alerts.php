<?php
if (isset($_SESSION['addcases_success'])) {
  echo "
  ...
  unset($_SESSION['addcases_success']);
}

if (isset($_SESSION['addcases_error'])) {
  echo "
