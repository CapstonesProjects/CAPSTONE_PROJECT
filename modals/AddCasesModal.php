            ...
            <div class="modal-body">
                <form id="addCaseForm" action="../phpfiles/add_case.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="reportAttachment" name="ReportAttachment">
                    </div>
                    <div class="mb-3" id="writtenReprimandAttachmentContainer">
                        ...
                        <input type="file" class="form-control" id="writtenReprimandAttachment" name="WrittenReprimandAttachment">
                    </div>
                    <div class="mb-3">
                        <label for="sanctionLetterAttachment" class="form-label">Sanction Letter Attachment</label>
                        <input type="file" class="form-control" id="sanctionLetterAttachment" name="SanctionLetterAttachment">
                    </div>
