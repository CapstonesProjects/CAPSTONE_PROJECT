<div class="modal fade" id="ChangePasswordModal<?php echo $_SESSION['OrgID']; ?>" tabindex="-1" role="dialog" aria-labelledby="ChangePasswordModalLabel<?php echo $_SESSION['OrgID']; ?>" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="text-xl font-medium text-gray-900" id="ChangePasswordModalLabel<?php echo $_SESSION['OrgID']; ?>">Change Password</h5>
            ...
            <div class="p-6 space-y-6">
                ...
                <form id="password-section" class="settings-section hidden border-t border-gray-200 pt-4 mt-4" action="../phpfiles/org_update_password.php" method="post">
