        ...
        <div id="sidebar" class="bg-gray-300 h-screen md:block shadow-xl px-12 w-30 md:w-60 lg:w-80 overflow-x-hidden transition-transform duration-300 ease-in-out">
            ...
            <div class="space-y-6 md:space-y-10 mt-10">
                ...
                <div id="menu" class="flex flex-col space-y-3" style="margin-top: -10%;">
                    ...
                    <!-- <a href="../OSA/OSA_Events.php" class="text-lg font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out">
...
<div id="composeWindow" class="fixed bottom-0 right-0 bg-white shadow-lg rounded-lg p-4 w-1/4 h-auto hidden">
    ...
    <form id="sendMessageForm" method="POST" action="../phpfiles/sendmessage_osa.php">
    <div class="mb-2">
    ...
    <input type="hidden" name="fullNameReceiver" id="fullNameReceiver"> <!-- Hidden input for FullNameReceiver -->
...
<div class="px-2 pt-4 pb-8 border-r border-gray-300">
    ...
    <ul>
        ...
        <div id="sent-content" class=" bg-gray-100 sections" style="display: none;">
            <br />
<b>Fatal error</b>:  Uncaught mysqli_sql_exception: Unknown column 'sender' in 'where clause' in C:\xampp\htdocs\CAPSTONE\components\sent_content_osa.php:15
Stack trace:
...
#2 C:\xampp\htdocs\CAPSTONE\OSA\OSA_SendMessage.php(54): include('C:\\xampp\\htdocs...')
#3 {main}
